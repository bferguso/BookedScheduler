...
require_once(dirname(__FILE__) . '/PreReservationUserUpdateService.php');

class PreReservationFnlg implements IPreReservationFactory
{
	/**
    ...
    public function __construct(PreReservationFactory $factoryToDecorate)
    {
        ...
        Log::Debug("Trying to load file ".dirname(__FILE__) . '/PreReservationFnlg.config.php');
		require_once(dirname(__FILE__) . '/PreReservationFnlg.config.php');

		Configuration::Instance()->Register(
					dirname(__FILE__) . '/PreReservationFnlg.config.php',
         'PreReservationFnlg');
    }
    ...
    public function CreatePreAddService(UserSession $userSession)
    {
        ...
        return new PreReservationUserUpdateService($base);
    }
