 ...
 */
$conf['settings']['app.title'] = '<fnlg_app_name>';			// application title
$conf['settings']['default.timezone'] = 'America/Vancouver';      // look up here http://php.net/manual/en/timezones.php
...
$conf['settings']['script.url'] = '<base_context_url>/booked/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['reservation']['prevent.recurrence'] = 'true';			// if recurring reservations are disabled for non-administrators
...
$conf['settings']['database']['user'] = '<fnlg_booked_db_user>';        // database user with permission to the booked database
$conf['settings']['database']['password'] = '<fnlg_booked_db_password>';
$conf['settings']['database']['hostspec'] = '<mysql_host>';        // ip, dns or named pipe
$conf['settings']['database']['name'] = '<fnlg_booked_db_name>';
/**
...
$conf['settings']['phpmailer']['smtp.secure'] = '<smtp_encryption>';             // options are '', 'ssl' or 'tls'
 ...
 */
$conf['settings']['plugins']['Authentication'] = 'Siteminder';
$conf['settings']['plugins']['Authorization'] = '';
$conf['settings']['plugins']['Permission'] = '';
$conf['settings']['plugins']['PostRegistration'] = '';
$conf['settings']['plugins']['PreReservation'] = 'PreReservationFnlg';
$conf['settings']['plugins']['PostReservation'] = 'PostReservationFnlg';
/**
...
# FNLG-specific settings
$conf['settings']['fnlg.context.url'] = '<base_context_url>';
$conf['settings']['fnlg.base.url'] = '<base_url_internal>';
$conf['settings']['fnlg.version'] = '<fnlg_version>';
$conf['settings']['fnlg.instance'] = '<deployment_instance>';
$conf['settings']['fnlg.deployment.number'] = '<fnlg_commit_number>';

$conf['settings']['fnlg.unauthorized.uri'] = '/unauthorized';

# Laravel API callbacks

# This requires the username to be appended to the end of the URL
$conf['settings']['fnlg.api.get.user'] = '/api/admin/system/user/';
$conf['settings']['fnlg.api.get.event.dates'] = '/api/admin/system/eventDates';

# Requires either ministry short name or "all" appended to the end of the URL
$conf['settings']['fnlg.api.get.unscheduled.requests'] = '/api/admin/system/meetingsToSchedule/';

# This requires booked reference number to be appended to the end of the URL
$conf['settings']['fnlg.api.get.request.by.reference_no'] = '/api/admin/system/requestByBookedReferenceNo/';

$conf['settings']['fnlg.api.mark.request.scheduled'] = '/api/admin/system/meetingRequests/markScheduled';
$conf['settings']['fnlg.api.mark.request.unscheduled'] = '/api/admin/system/meetingRequests/markUnscheduled';

$conf['settings']['fnlg.param.meeting.request.id'] = 'meeting_request_id';
$conf['settings']['fnlg.param.booked.reference.number'] = 'booked_reference_no';

// SiteMinder header keys
$conf['settings']['fnlg.sm.username.key'] = 'sm_universalid';
$conf['settings']['fnlg.sm.email.key'] = 'smgov_useremail';
$conf['settings']['fnlg.sm.display.name.key'] = 'smgov_userdisplayname';
$conf['settings']['fnlg.sm.realm.key'] = 'sm_realm';
$conf['settings']['fnlg.sm.user.type.key'] = 'smgov_usertype';

$conf['settings']['fnlg.custom.owner.attending.label'] = 'ownerIsAttending';
$conf['settings']['fnlg.custom.first_nation.id.label'] = 'fnlgFirstNationId';
